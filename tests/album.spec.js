...
describe('Albums', () => {
  ...
  describe('Smoke Tests', () => {
    ...
    it('should exist the method getAlbumTracks', () => {
  ...
  describe('getAlbums', () => {
    ...
    it('should call fetch with the correct URL', () => {
      ...
      const album2 = getAlbums(['382ObEPsp2rxGrnsizN5T1', '1A2GTWGtFfWp7KSQTwWOy2', '2noRn2Aes5aoNVsU6iWTh3']);
      expect(stubedFetch).to.have.been
        .calledWith('https://api.spotify.com/v1/albums/ids?382ObEPsp2rxGrnsizN5T1,1A2GTWGtFfWp7KSQTwWOy2,2noRn2Aes5aoNVsU6iWTh3');
    });

    it('should return the correct data from Promise', () => {
      promise.resolves({ album: 'name' });
      const album = getAlbums(['1A2GTWGtFfWp7KSQTwWOy2', '1A2GTWGtFfWp7KSQTwWOy2']);
      expect(album.resolveValue).to.be.eql({ album: 'name' });
    });
  });
